...
ActiveRecord::Schema.define(version: 20_200_107_180_648) do
  ...
  create_table 'budget_category_maturity_intervals', force: :cascade do |t|
    ...
    t.index %w[budget_category_id budget_interval_id], name: 'index_category_interval_uniqueness', unique: true
  end
